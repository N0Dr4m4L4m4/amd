...
class changeFilmWindow(QtWidgets.QDialog):
    ...
    def addFilmRelatedPerson(self):
        ...
        dialog.showdialog("Personenrolle hinzugefügt",response[0][0])
        self.getPersonTable()
        self.resetInput()
